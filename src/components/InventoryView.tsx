...
import { Plus, Search, Check, AlertCircle, Edit2, Package, Sparkles, RotateCcw, ShieldAlert, AlertTriangle } from "lucide-react";
import {
  Card,
  CardHeader,
  CardTitle,
                    ...
                    >
                      ...
                      <TableCell className="text-center">
                        <div className="flex items-center justify-center gap-1.5">
                          ...
                          <button
                            onClick={() => setEditingProduct(product)}
                            className="p-1 text-slate-400 hover:text-slate-900 cursor-pointer rounded hover:bg-slate-100"
                          >
